...
class newSecret(forms.ModelForm):
	...
	options = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Options", "class":"form-control"}),label="")
